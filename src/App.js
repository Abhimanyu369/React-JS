...
class App extends Component {
  ...
  static defaultProps = {
    clientID : 'sHLbxjjcFb5xBbiGsfGOwJfDbtjwC0Cu',
    domain : 'abhimanyu28.auth0.com'
  }
  ...
  componentWillMount(){
    ...
    this.lock.on('authenticated', (authResult) =>{
      ...
      //Dont use idToken -- this.lock.getProfile(authResult.idToken, (error, profile) => {
      //It will give you error 401 unauthorized credentials
